...
def generate_launch_description():
    ...
    communication_dir = get_package_share_directory("serial_communication")
    ...
    declare_communication_cfg_dir = DeclareLaunchArgument(
        ...
        default_value=PathJoinSubstitution([communication_dir, "config", "serial_communication.yaml"]),
